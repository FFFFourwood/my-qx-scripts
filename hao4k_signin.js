...
// const url = 'https://www.hao4k.cn/plugin.php'
const url = 'https://www.hao4k.cn/plugin.php?id=k_misign:sign&operation=qiandao&formhash=df87be5c&format=empty'
const data = {
    'id': 'k_misign:sign',
    'operation': 'qiandao',
    'formhash': 'df87be5c',
...
$task.fetch(myRequest).then(response => {
    ...
    $notify("hao4k签到提醒", "请求成功", response.body); // Success!
    $done();
}, reason => {
    // reason.error
